package com.hcycom.sso.config.audit;
...
import com.hcycom.sso.domain.PersistentAuditEvent;
...
public class AuditEventConverter {
     ...
     */
    public List<AuditEvent> convertToAuditEvent1(Iterable<PersistentAuditEvent> persistentAuditEvents) {
