 ...
 * @param <V>
 */
public class ExpiryMapUtil<K, V> extends HashMap<K, V> {
    ...
    public ExpiryMapUtil() {
        super();
    }

    public ExpiryMapUtil(long defaultExpiryTime) {
        this(1 << 4, defaultExpiryTime);
    }

    public ExpiryMapUtil(int initialCapacity, long defaultExpiryTime) {
